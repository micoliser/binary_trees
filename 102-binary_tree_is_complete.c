...
/**
 * binary_tree_siz - measures the size of a binary tree
 *
 * @tree: tree root
 * Return: size of the tree or 0 if tree is NULL;
 */
size_t binary_tree_siz(const binary_tree_t *tree)
{
	if (tree == NULL)
		return (0);

	return (binary_tree_siz(tree->left) + binary_tree_siz(tree->right) + 1);
}
